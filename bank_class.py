...
class Bank:
    ...
    def add_client(self, new_client_name, initial_balance): #create new client instance and add it to client_list
        ...
        new_client = client_class.Client(new_client_ID, new_client_name, initial_balance)
    ...
    def get_all_clients_info(self): #return str containing info about all clients in the bank
        message = ""
        for client in self.client_list:
    ...
    def get_client_transactions(self, client_name):#takes client instance and returns transaction history
        for client in self.client_list:
            if client.name == client_name:
                return client.get_transaction_history()
